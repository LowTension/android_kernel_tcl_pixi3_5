...
static unsigned char CTPM_FW_JUNDA[]={
	//#include "FT6406_V01_20140426_app.i"
     //   #include "Pixi3_5_6436L_ID85_V0a_20150331_app.i"
     //#include "Pixi3_5_3G_GL_6436L_ID85_V10_20150707_app.i"
    // #include "Pixi3_5_3G_GL_6436L_ID85_V11_20150709_app.i"  
	//#include "Pixi3_5_3G_GL_6436L_ID85_Vf0_20150902_app.i" //jiangjingjing-modify-for-doubletap-20151014
        //#include "Pixi3_5_3G_GL_6436L_ID85_V13_20151023_app.i" //20151024 liujunting modify for doubletap
	#include "Pixi3_5_3G_GL_6436L_ID85_Vf1_20151224_app.i"  //begin-liuxin-modify-D1214260
};

  	 /*Begin ersen.shang for add 3nd ctp LCE 20150910*/	 
static unsigned char CTPM_FW_LCE[]={
     	//#include   "Pixi3_5_3G_GL_6336S_ID87_V10_20150909_app.i"
        //20151020 modify by liujunting for pixi3-5
         #include   "Pixi3_5_3G_GL_6336S_ID87_V11_20151015_app.i"
};	
  	 /*End   ersen.shang for add 3nd ctp LCE 20150910*/

/*Begin ersen.shang for add 3nd ctp LCE 20150910*/	 
extern char tpd_vendor_id;
/*End   ersen.shang for add 3nd ctp LCE 20150910*/	 
...
upgrade with *.i file
*/
/*note: ersen.shang modify CTPM_FW to CTPM_FW[tpd_vendor_id] for difference vendor in this function*/
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	if(tpd_vendor_id == CTP_VENDOR_JUNDA)
	{
		fw_len = sizeof(CTPM_FW_JUNDA);
		CTPM_FW = CTPM_FW_JUNDA;
	}
	else if (tpd_vendor_id == CTP_VENDOR_LCE)
	{
...
*/
/*Begin-liuxin-Task863340 for ctp optimization-add a forloop to make sure get vendorid correctly then return vendorid(retVal) not 0--20151105*/
...
/*End-liuxin-Task863340 for ctp optimization-add a forloop to make sure get vendorid correctly then return vendorid(retVal) not 0--20151105*/
...
int fts_5x36_ctpm_fw_upgrade(struct i2c_client *client, u8 *pbt_buf, u32 dw_lenth)
{
	...
	if(tpd_vendor_id == CTP_VENDOR_JUNDA)
	{
		fw_filenth = sizeof(CTPM_FW_JUNDA);
		CTPM_FW = CTPM_FW_JUNDA;
	}
	else if (tpd_vendor_id == CTP_VENDOR_LCE)
	{
		fw_filenth = sizeof(CTPM_FW_LCE);
		CTPM_FW = CTPM_FW_LCE;		
	}
