...
#define KPOC_USB_PRODUCT_ID 0x0168 // modify for tcl
...
//begin--dengguangxi modify for SDM:sys.usb.product,20150403
...
static DEVICE_ATTR(field, S_IRUGO | S_IWUSR, field ## _show, field ## _store);
//end--dengguangxi modify for SDM:sys.usb.product,20150403
