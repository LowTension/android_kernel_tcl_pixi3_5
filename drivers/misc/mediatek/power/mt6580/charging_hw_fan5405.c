...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	fan5405_reg_config_interface(0x00,0x80);        //kick chip watch dog
	#if 0
	if (chargerled_flag < 30) 
	{
		chargerled_flag +=1;
		fan5405_reg_config_interface(0x00,0xC0);        //kick chip watch dog
		printk("jiale test charge led\n");
	}
	else
	{
		chargerled_flag = 100;
		printk("jiale test charge led 0x00 0x08\n");
		fan5405_reg_config_interface(0x00,0x80);        //kick chip watch dog
	}
	#endif
