						...
						TaskStruct *pTask, int32_t thread, const int32_t waitQ)
{
	...
	do {
		...
		pNextTask = NULL;
	       if (pTask->pCMDEnd != NULL) { //jiangjingjing-add-accroidng to mtk solution-defect:537251-20150902
		...
		}//jiangjingjing-add-accroidng to mtk solution-defect:537251-20150902
