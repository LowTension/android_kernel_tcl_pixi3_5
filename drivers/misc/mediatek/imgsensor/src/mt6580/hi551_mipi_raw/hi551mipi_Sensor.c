...
static imgsensor_info_struct imgsensor_info = {
    ...
    .cap_delay_frame = 1,        //old:3,enter capture delay frame num
    .pre_delay_frame = 1,         //old:3,enter preview delay frame num
    .video_delay_frame = 1,        //old:3,enter video delay frame num
...
write_cmos_sensor(0x0A10, 0x4000); //Pedestal value  64
