...
#include "gc2355_pixi3_55_mipi_Sensor.h"

#define GC2355MIPI_2Lane   //   for  mipi lane num
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2355_pixi3_55_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2355_PIXI3_55_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
    ...
    .cap_delay_frame = 1,        //old:3 jiangjingjing-modify-20150624 enter capture delay frame num
    .pre_delay_frame = 1,         //old:3 jiangjingjing-modify-20150624 enter preview delay frame num
    .video_delay_frame = 1,        //old:3 jiangjingjing-modify-20150624 enter video delay frame num
...
if(0==mt_get_gpio_in(GPIO_SUB_CAM_ID_PIN))
{
    LOG_INF("the module factory is huaquan\n");
...
UINT32 GC2355_PIXI3_55_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
