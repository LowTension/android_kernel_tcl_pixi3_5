...
#include "gc2356mipi_Sensor.h"

#define GC2356MIPI_2Lane   //   for  mipi lane num
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2356_camera_sensor"
#define LOG_1 LOG_INF("GC2356,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2356_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
    ...
    .cap_delay_frame = 1,        //old:3 jiangjingjing modify enter capture delay frame num
    .pre_delay_frame = 1,         //old:3 jiangjingjing modify enter preview delay frame num
    .video_delay_frame = 1,        //old:3 jiangjingjing modify enter video delay frame num
...
static void set_dummy()
{
	...
	hb = imgsensor.dummy_pixel + GC2356_DEFAULT_DUMMY_PIXEL_NUMS;
	vb = imgsensor.dummy_line + GC2356_DEFAULT_DUMMY_LINE_NUMS;
...
//			LOG_INF("GC2356 analogic gain 1x , GC2356 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_2<= iReg)&&(iReg < ANALOG_GAIN_3))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			LOG_INF("GC2356 analogic gain 1.45x , GC2356 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			LOG_INF("GC2356 analogic gain 2.02x , GC2356 add pregain = %d\n",temp);
	}
...
//			LOG_INF("GC2356 analogic gain 2.8x, temp = %d\n", temp);
	}
...
/////////////////////////////////////////////////////
...
#endif
	write_cmos_sensor(0x02, 0x11); // 00 20150522 11
	...
	write_cmos_sensor(0x94,0x0b);//00
...
if(1==mt_get_gpio_in(GPIO_SUB_CAM_ID_PIN))
{
    LOG_INF("the module factory is qunhui");
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	    ...
	    imgsensor_info.sensor_id= GC2356_SENSOR_ID;
		if(0x2356==imgsensor_info.sensor_id){
		imgsensor_info.sensor_id=0x2355;
    ...
    return ERROR_NONE;
		...
		LOG_INF("camera id pin is failed\n");
		return ERROR_SENSOR_CONNECT_FAIL;
	}
}
