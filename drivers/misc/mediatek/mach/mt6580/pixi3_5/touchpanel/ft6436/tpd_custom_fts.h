...
#define FTS_GESTRUE                //jiangjingjing- modify-for-doubletap-20151014 // if need the gesture funtion,enable this MACRO
...
#define CTP_VENDOR_LCE     1
#define CTP_VENDOR_JUNDA   0
