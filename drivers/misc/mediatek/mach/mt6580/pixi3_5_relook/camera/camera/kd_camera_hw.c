...
u32 pinSet[3][8] = {
    ...
    if(pinSetIdx == 0 && (0 != strcmp(currSensorName,SENSOR_DRVNAME_OV5670_MIPI_RAW))&& (0 != strcmp(currSensorName,SENSOR_DRVNAME_OV5670FF_MIPI_RAW))&& (0 != strcmp(currSensorName,SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW))&&(0 != strcmp(currSensorName,SENSOR_DRVNAME_S5K5E2YAAF_MIPI_RAW)))
    	return 0;
    if(pinSetIdx == 1 && (0 != strcmp(currSensorName,SENSOR_DRVNAME_GC0339_MIPI_RAW))&& (0 != strcmp(currSensorName,SENSOR_DRVNAME_GC2355_MIPI_RAW))&& (0 != strcmp(currSensorName,SENSOR_DRVNAME_OV5670_FRONT_MIPI_RAW))&& (0 != strcmp(currSensorName,SENSOR_DRVNAME_OV2680_MIPI_RAW)))
    	return 0;
