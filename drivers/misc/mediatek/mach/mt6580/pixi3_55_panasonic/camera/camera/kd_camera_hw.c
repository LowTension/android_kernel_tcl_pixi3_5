...
*/
	...
	ISP_MCLK2_EN(1);
	...
	else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_PIXI3_55_MIPI_RAW, currSensorName)))
        {
        #if 0
            mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
            mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
        ...
        else  if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355_PIXI3_55_MIPI_RAW, currSensorName)))
		||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2356_MIPI_RAW, currSensorName))))
        {
        #if 0
            mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
            mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
