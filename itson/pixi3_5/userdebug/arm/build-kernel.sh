...
#begin minguo.wan disable 2015.12.18 for cr1058672 ItsOn ref page27 ItsOn Ingration guide _MTK_5.1_20151016.pdf
#echo ""
#echo ">>> make ${J} ARCH=${ARCH} CROSS_COMPILE=${TOOLCHAIN} modules_prepare"
#make ${J} ARCH=${ARCH} CROSS_COMPILE=${TOOLCHAIN} modules_prepare
#end minguo.wan disable 2015.12.18 for cr1058672 ItsOn ref page27 ItsOn Ingration guide _MTK_5.1_20151016.pdf
