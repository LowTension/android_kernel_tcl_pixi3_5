...
//#ifdef CONFIG_MTK_SPEAKER//MODIFY BY XIAOPU.ZHU for extera PA compile error
static int Speaker_mode = AUDIO_SPEAKER_MODE_D;//AUDIO_SPEAKER_MODE_AB; //default use type D on 82
#ifdef CONFIG_MTK_SPEAKER//jiangjingjing-modify-for-pixi3-55-20150418
static unsigned int Speaker_pga_gain = 1 ; // default 0Db.
static bool mSpeaker_Ocflag = false;
#endif//jiangjingjing-modify-for-pixi3-55-20150418
...
static void Audio_Amp_Change(int channels , bool enable)
{
    if (enable)
    {
            ...
            mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETR] == false)
        {
            ...
            //jiangjingjing-add-for-pixi3_55-20150418
            ...
            #endif//jiangjingjing-add-for-pixi3_55-20150418
            //jiangjingjing delete for pixi3-55-20150511
			//it only for pixi3-5,and make pixi3-55 sound of speaker not enough loud
            // Ana_Set_Reg(AUDTOP_CON4, 0x005C, 0xffff); // enable audio bias. only enable audio-R DAC, HP buffers (L needs to turn off)
            }
            else
            {
...
#ifdef CONFIG_MTK_SPEAKER//jiangjingjing-add-for-pixi3-55-20150418
