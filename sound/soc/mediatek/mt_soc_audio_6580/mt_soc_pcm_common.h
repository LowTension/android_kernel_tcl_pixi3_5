...
#define MEMCPY_SINGLE_MODE //add by zyurong for task664143 20150923
...
unsigned long mtk_local_audio_copy_from_user(bool IsSRAM, kal_uint8 * dst,char * src, int len); //add by zyurong for task664143 20150923
unsigned long mtk_local_audio_copy_to_user(bool IsSRAM, kal_uint8 * dst,char * src, int len); //add by zyurong for task664143 20150923
